...
# Robert Puryear
# November 13, 2021
# Group Project -  main module using student functions
#

# fairly certain we're not submitting this file, right? - Jake
...
def main():
    ...
    add_course(1001, course_roster, course_max_size)
    drop_course(1001, course_roster)
    list_courses(1001, course_roster)
